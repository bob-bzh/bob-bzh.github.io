...
// <script type="text/javascript" src="/jquery-v3.6.0.js"></script>
//document.createElement("script").setAttribute("src", "jquery-v3.6.0.js");
/* function addScript() {
  document.write("<script type='text/javascript' language=javascript src=/js/" + "jquery-v3.6.0.js" + "></script>")
}
addScript() */
